        ...
        if (result[0] != ""){
          ...
          element.innerHTML = `
            ...
            <div class="siimple-grid-row">
              ...
              <div class="siimple-grid-col siimple-grid-col--2 siimple-grid-col-sm--12" align=center><div style="width: 100%; padding: 3px; margin-bottom: 2px; margin-top: 2px;" onclick="runShutterCmd('prog', ` + channel_id  + `)" class="siimple-btn siimple-btn--navy">PROG</div></div>
            </div>
            <br><br>
          `;
